...
export default class ModalUtil {
  ...
  static openMsgInfo(msg, isControlByDebounce = true) {
    ...
    const openMsg = () => {
      ...
      this.$messageInstance = window.$vue.$message({message: msg, duration: 800, showClose: true});
    };
  ...
  static openMsgSuccess(msg, isControlByDebounce = true) {
    ...
    const openMsg = () => {
      this.$messageInstance && this.$messageInstance.close();
      this.$messageInstance = window.$vue.$message({message: msg, type: 'success', duration: 800, showClose: true});
    };
    // 若用debounce进行限制，
    if (isControlByDebounce) {
      // 采用debounce限制弹出框，在300毫秒内，不弹出第二次
  ...
  static openMsgWarning(msg, isControlByDebounce = true) {
    ...
    const openMsg = () => {
      this.$messageInstance && this.$messageInstance.close();
      this.$messageInstance = window.$vue.$message({message: msg, type: 'warning', duration: 800, showClose: true});
    };
  ...
  static openMsgError(msg, isControlByDebounce = true) {
    ...
    const openMsg = () => {
      this.$messageInstance && this.$messageInstance.close();
      this.$messageInstance = window.$vue.$message({message: msg, type: 'error', duration: 800, showClose: true});
    };
  ...
  static toastWarn(err, defaultValue = '请求失败') {
    ...
    ModalUtil.openMsgWarning(err?.msg || defaultValue);
  }
  ...
  static toastError(err, defaultValue = '请求失败') {
    ...
    ModalUtil.openMsgError(err?.msg || defaultValue);
  }
