...
<template>
  <div :class="['b__info-modal', className]">
    <div class="b__info-modal__body">
    ...
    <div class="ly-btn-group-inline gap-none b__info-modal__footer ly-p-8 ">
